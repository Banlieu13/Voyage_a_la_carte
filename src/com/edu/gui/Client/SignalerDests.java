 ...
 * @author MrBenrhouma
 */
public class SignalerDests extends javax.swing.JFrame {

    /**
     * Creates new form SignalerDests
     */
    public SignalerDests() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 111, 310, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(78, 41, -1, -1));

        cbtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Politique", "Faux profil", "Impoli", " ", " ", " " }));
        getContentPane().add(cbtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 41, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(278, 251, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        s.setId_dest(d.idDests);
        //s.setId_com();
        //s.setId_annonce(null);
        sd.insertSignaldestC(s);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignalerDests.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignalerDests().setVisible(true);
            }
        });
    }
