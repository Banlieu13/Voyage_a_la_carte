 ...
 * @author Commando
 */
public class ListeAnnonceAlertes extends javax.swing.JFrame {

    /**
     * Creates new form ListeAnnonceAlertes
     */
    public ListeAnnonceAlertes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tableannonce = new javax.swing.JTable();
        ...
        tableannonce.setModel(new com.edu.entities.Table.TableAnnonceAlertes());
        jScrollPane1.setViewportView(tableannonce);
        ...
        jLabel1.setText("Annonces Alertes :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int x = tableannonce.getSelectedRow();
        if (x<0){
            msg.setText("Veuillez choisir une alerte");
        }else{
        
        GererAlerteDAO gad= new GererAlerteDAO();
        int i = (int) tableannonce.getValueAt(0, 3);
        gad.setID(i);
        gad.setSource("annonce");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListeAnnonceAlertes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListeAnnonceAlertes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableannonce;
