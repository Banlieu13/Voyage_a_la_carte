 ...
 * @author Commando
 */
public class ListDistinationAlertes extends javax.swing.JFrame {

    /**
     * Creates new form ListDistinationAlertes
     */
    public ListDistinationAlertes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabledest = new javax.swing.JTable();
        ...
        tabledest.setModel(new com.edu.entities.Table.TableDistinationAlertes());
        jScrollPane1.setViewportView(tabledest);

        jLabel1.setText("Distinations Alertes :");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(msg, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(265, 265, 265)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            int x = tabledest.getSelectedRow();
        if (x<0){
            msg.setText("Veuillez choisir une alerte");
        }else{
        
        GererAlerteDAO gad= new GererAlerteDAO();
        int i = (int) tabledest.getValueAt(0, 3);
        gad.setID(i);
        gad.setSource("destination");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListDistinationAlertes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListDistinationAlertes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabledest;
