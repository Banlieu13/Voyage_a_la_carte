 ...
 * @author MrBenrhouma
 */
public class ProfilResp extends javax.swing.JFrame {

    /**
     * Creates new form ProfilResp
     */
    public ProfilResp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(profil, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, -1, -1));
        ...
        getContentPane().add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 470, 250, 20));
        ...
        getContentPane().add(btnvalider1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 510, 123, 35));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
         ...
         c=cd.chercherResponsable(a.identifiant);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfilResp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfilResp().setVisible(true);
            }
        });
    }
