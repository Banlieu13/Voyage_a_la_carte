 ...
 * @author MrBenrhouma
 */
public class ModifierAnn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Modifier votre annonce");
        ...
        getContentPane().add(msg, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 650, 250, 20));
        ...
        getContentPane().add(btnValid, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 630, 123, 35));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        AnnonceDAO ada = new AnnonceDAO();
        Annonce ann = new Annonce();
        ann = ada.FindannonceeById(a.IdAnnonce);
        String[] ch = ann.getCircuit().split(",");
        jprog.setText(ann.getProgramme());
        jde.setText(ch[0]);
        jvers.setText(ch[1]);
        jnbrplace.setText(""+ann.getNbrplace());
        jhotel.setText(ann.getHotel());
        jDateChooser1.setDate(ann.getDatean());
        jprix.setText(""+ann.getPrix());
        ImageIcon ima1 = new ImageIcon();
        ima1 = ada.chercherPicAnnonce(a.IdAnnonce).get(0);
        jpic1.setIcon(ima1);
        
        ImageIcon ima2 = new ImageIcon();
        ima2 = ada.chercherPicAnnonce(a.IdAnnonce).get(1);
        jpic2.setIcon(ima2);
        
        ImageIcon ima3 = new ImageIcon();
        ima3 = ada.chercherPicAnnonce(a.IdAnnonce).get(2);
        jpic3.setIcon(ima3);
        
        ImageIcon ima4 = new ImageIcon();
        ima4 = ada.chercherPicAnnonce(a.IdAnnonce).get(3);
        jpic4.setIcon(ima4);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierAnn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifierAnn().setVisible(true);
            }
        });
    }
